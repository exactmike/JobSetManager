#
# Module manifest for module 'JobSetManager'
#
...
@{
    ...
    GUID                 = 'ff451c16-973e-4b8f-b26e-fc53666bdc82'
    ...
    Description          = 'add on module for poshrsjob, threadjob, or standard PS Jobs to manage job hierarchies'
    ...
    FunctionsToExport    = @(
        ...
        'Get-JSMJobSetDiagram'
        'Get-JSMJobNext'
        'Get-JSMJobRequired'
        'Get-JSMStopwatch'
        'Get-JSMVariable'
        'Get-JSMVariableValue'
    ...
    PrivateData          = @{
        ...
        PSData = @{
            ...
            ProjectUri = 'https://github.com/exactmike/JobSetManager'
